...
movies = [
    ...
    '''A seemingly indestructible humanoid cyborg is sent from 2029 to 1984 to assassinate a waitress,
    whose unborn son will lead humanity in a war against the machines, while a soldier from that war is
    ...
    "https://upload.wikimedia.org/wikipedia/en/9/94/Pink_Floyd_The_Wall.jpg",
    "https://youtu.be/5CJRnRyA4wA"),

    Movie("Abre Los Ojos",
    '''A very handsome man finds the love of his life, but he suffers an accident and needs to have his
    face rebuilt by surgery after it is severely disfigured..''',
    "https://upload.wikimedia.org/wikipedia/en/a/a6/Abre_los_ojos_movie.jpg",
    "https://youtu.be/PBtnPuB0x3U"),

    Movie("Transcendence",
    '''A scientist's drive for artificial intelligence, takes on dangerous implications when his consciousness
    ...
    '''Gaetano and Delia, a separated couple, try to pick up the pieces of their broken love,
    recalling all the faults and the mistakes which led them to where they are now.''',
    "https://upload.wikimedia.org/wikipedia/en/5/5d/Don%27t_Move%282004%29.jpg",
    "https://youtu.be/Wn4V8BXzjNI"),

    Movie("Tropa de Elite",
    ''' Captain Nascimento has to find a substitute for his occupation while
